  <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0">
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <li>
                  <a href="{{ route('admin.logout') }}" class="btn btn-danger btn-sm">Log out</a>
              </li>
          </ul>
      </nav>
      <!-- /.navbar -->
          ...
          <div class="sidebar">
              ...
              <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                      ...
                      <li class="nav-item">
                          <a href="{{ route('supplier.area') }}" class="nav-link">
                      ...
                      <li class="nav-item">
                          <a href="{{ route('admin.all_categories') }}" class="nav-link">
                              <i class="nav-icon fas fa-edit"></i>
                              <p>
                                  Blog Category
                              </p>
